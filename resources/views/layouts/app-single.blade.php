...
<head>
    ...
    <link href="{{ asset('css/single.css') }}" rel="preload" as="style" onload="this.onload=null;this.rel='stylesheet'">
</head>
<body>
    ...
    <header class="height-menu">
        <div class="container">
            <div class="header-content single-header-content">
                ...
                @include('partials.menu-subpage')

                @include('partials.lang-switch')
            </div>
        </div>

        @include('partials.menu-subpage-mobile')
