            ...
            <div class="main-block">
                <div class="main-top-block">
                    <div class="single-main-slider">
                        <div class="main-slider-item"><img src="/img/gallery-big-photo.png" alt="alt"></div>
                        <div class="main-slider-item"><img src="/img/gallery-small-photo1.png" alt="alt"></div>
                        <div class="main-slider-item"><img src="/img/gallery-small-photo2.png" alt="alt"></div>
                        <div class="main-slider-item"><img src="/img/gallery-small-photo3.png" alt="alt"></div>
                        <div class="main-slider-item"><img src="/img/gallery-small-photo4.png" alt="alt"></div>
                    </div>
                    <div class="sidebar mobile-sidebar">
                        ...
                        <div class="sidebar-bottom">
                            <div class="sidebar-bottom-block">
                                <a class="teilen" href="#">
                                    <img class="not-hover" src="/svg/i-share.svg" alt="">
                                    <img class="hover" src="/svg/i-share-hover.svg" alt="">
                                    <span>Teilen</span>
                                </a>
                            </div>
                            <div class="sidebar-bottom-block">
                                <a class="drucken" href="#">
                                    <img class="not-hover" src="/svg/i-print.svg" alt="">
                                    <img class="hover" src="/svg/i-print-hover.svg" alt="">
                                    <span>Drucken</span>
                                </a>
                            </div>
                            <div class="sidebar-bottom-block">
                        ...
                        <div class="share-block sidebar-small-block">
                            ...
                            <div class="share-block-content">
                                <div class="row">
                                    <div class="col-xl-4 share-block-item">
                                        <a href="#">
