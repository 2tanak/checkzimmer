                ...
                <div class="sample-block">
                    <div class="input-block sample-block-item">
                        ...
                        <div class="input-container">
                            <input  id="text" type="text" placeholder="{{ __('Example') }}: 04315 Leipzig">
                        </div>
                    </div>
        ...
        <div class="plans-content city-content">
            <div class="plans-container">
                ...
                <div class="price-block">
                    <a href="http://leipzig.check-zimmer.de" class="price-block-item">
                        <div class="price-block-head">
                            <div class="name-tariff">100 свободных мест</div>
                            <div class="price-item">
                                <div class="max-price">Leipzig</div>
                            </div>
                    ...
                    <a href="http://schkeuditz.check-zimmer.de" class="price-block-item">
                        <div class="price-block-head">
                            <div class="name-tariff">200 {{ __('free places') }}</div>
                            <div class="price-item">
                                <div class="max-price">Schkeuditz</div>
                            </div>
                            <div class="description">
                                {{ __('For most businesses that want to optimize web queries') }}
                            </div>
                    ...
                    <a href="http://halle.check-zimmer.de" class="price-block-item">
                        <div class="price-block-head">
                            <div class="name-tariff">300 {{ __('free places') }}</div>
                            <div class="price-item">
                                <div class="max-price">Halle (Saale)</div>
                            </div>
                            <div class="description">
                                {{ __('For most businesses that want to optimize web queries') }}
                            </div>
                    ...
                    <a href="http://bitterfeld.check-zimmer.de" class="price-block-item">
                        <div class="price-block-head">
                            <div class="name-tariff">400 {{ __('free places') }}</div>
                            <div class="price-item">
                                <div class="max-price">Bitterfeld-Wolfen</div>
                            </div>
                            <div class="description">
                                {{ __('For most businesses that want to optimize web queries') }}
                            </div>
                    ...
                    <a href="http://sandersdorf.check-zimmer.de" class="price-block-item">
                        <div class="price-block-head">
                            <div class="name-tariff">400 {{ __('free places') }}</div>
                            <div class="price-item">
                                <div class="max-price">Sandersdorf</div>
                            </div>
                            <div class="description">
                                {{ __('For most businesses that want to optimize web queries') }}
                            </div>
                    ...
                    <a href="http://chemnitz.check-zimmer.de" class="price-block-item">
                        <div class="price-block-head">
                            <div class="name-tariff">400 {{ __('free places') }}</div>
                            <div class="price-item">
                                <div class="max-price">Chemnitz</div>
                            </div>
                            <div class="description">
                                {{ __('For most businesses that want to optimize web queries') }}
                            </div>
