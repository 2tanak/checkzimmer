        ...
        <div class="mobile-object-description" id="object-description-mobile">
            ...
            <div class="reviews-content mobile-reviews-content paddings-block">
                <div class="head-collapse" data-toggle="collapse" data-target="#mobile-reviews-content-collapse" aria-expanded="false" aria-controls="mobile-reviews-content-collapse">
                    <div>{{ $t('Reviews') }} <span class="rev-number">({{ reviews.length }})</span></div>
                    <div class="decompose-button"></div>
                </div>
                <div class="collapse" id="mobile-reviews-content-collapse">
                    ...
                    <div class="link-container">
                        <a :class="{'give-feedback': true, 'hide': feedbackForm}" href="#" @click.prevent="toggleFeedbackForm">
                            {{ $t('Give feedback') }}
                        </a>
                    </div>
                    <div  :class="{'empty-block': true, 'active': feedbackForm}" >
                        <div class="reviews-form">
                            ...
                            <form action="review/create" @submit.prevent="addReviews">
                                <div class="top-form">
                                    <input type="text" v-model="reviewsForm.name" :placeholder="$t('Your name')">
                                    <input type="text" v-model="reviewsForm.company" :placeholder="$t('Company name')">
                                    <input type="hidden" name="rating" :value="clickedStars">
            ...
            <div class="questions-content mobile-questions-content paddings-block">
                ...
                <div class="collapse" id="mobile-questions-content-collapse">
                    <form class="questions-form" action="question/create" @submit.prevent="addQuestion">
                        <input type="text" v-model="questionsForm.text" :placeholder="$t('Ask your question')" name="question">
                        <input type="submit" :value="$t('Send')">
                    </form>
                    <div class="questions-received">
