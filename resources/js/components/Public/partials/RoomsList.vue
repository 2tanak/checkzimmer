<template>
    <div class="table-container">
        <div class="type">
            ...
            <div v-for="room in rooms.slice(0, 5)" class="visible-part">
                ...
                <div class="type-block price-block"><b>{{ getMinRoomPrice(room) }}&#8364;</b>/{{ $t('persone') }}</div>
            </div>
        </div>
        <div class="type collapse fade" v-for="room in rooms.slice(5)" :id="'id-' + item_id">
        ...
        <a v-if="rooms.length > 5" :href="'#' + 'id-' + item_id" class="all-types" :aria-controls="'id-' + item_id" role="button" aria-expanded="false" data-toggle="collapse">
