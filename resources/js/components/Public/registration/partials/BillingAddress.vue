        ...
        <form class="billing-address-form">
            ...
            <div class="forms-line company-line">
                <div class="company-name forms-line-block">
                    ...
                    <input type="text" v-bind:placeholder="$t('Please enter your company name')" id="name-company" name="name-company" v-model="data.company">
                </div>
            ...
            <div class="forms-line">
                ...
                <div class="name-block forms-line-block">
                    ...
                    <input type="text" v-bind:placeholder="$t('Please enter your name')" name="name-input" id="name-input" v-model="data.person.first_name" @input="toContactDetails">
                ...
                <div class="surname-block forms-line-block">
                    ...
                    <input type="text" v-bind:placeholder="$t('Enter your last name')" name="surname-input" id="surname-input" v-model="data.person.last_name" @input="toContactDetails">
            ...
            <div class="forms-line">
                <div class="street-block forms-line-block">
                    ...
                    <input type="text" v-bind:placeholder="$t('Indicate your street')" id="street-input" name="street-input" v-model="data.address.street">
                ...
                <div class="house-number-block forms-line-block">
                    ...
                    <input type="text" v-bind:placeholder="$t('House number')" id="house-number-input" name="house-number-input" v-model="data.address.house">
            ...
            <div class="forms-line">
                <div class="zip-block forms-line-block">
                    ...
                    <input type="text" v-bind:placeholder="$t('Your postcode')" id="zip-input" name="zip-input" v-model="data.address.postcode">
                ...
                <div class="city-block forms-line-block">
                    ...
                    <input type="text" v-bind:placeholder="$t('Enter your city')" id="city-input" name="city-input" v-model="data.address.city">
